...
class Repro(torch.nn.Module):
    def forward(self, arg309_1: "bf16[3072, 1024]"):
        ...
        permute_default: "bf16[1024, 3072]" = torch.ops.aten.permute.default(arg309_1, [1, 0]);  arg309_1 = None
...
def make_inputs():
    return [
    torch.randn([3072, 1024], dtype=torch.bfloat16, device='cuda'),
    ]
