...
class Repro(torch.nn.Module):
    def forward(self, arg306_1: "bf16[1024, 2048]"):
        ...
        permute_default: "bf16[2048, 1024]" = torch.ops.aten.permute.default(arg306_1, [1, 0]);  arg306_1 = None
...
def make_inputs():
    return [
    torch.randn([1024, 2048], dtype=torch.bfloat16, device='cuda'),
    ]
