...
class Repro(torch.nn.Module):
    def forward(self, mm_191: "bf16[2048, 1024]"):
        ...
        reshape_default: "bf16[4, 512, 1024]" = torch.ops.aten.reshape.default(mm_191, [4, 512, 1024]);  mm_191 = None
        reshape_default_1: "bf16[4, 512, 8, 128]" = torch.ops.aten.reshape.default(reshape_default, [4, 512, -1, 128]);  reshape_default = None
        ...
        expand_default: "bf16[4, 8, 2, 512, 128]" = torch.ops.aten.expand.default(unsqueeze_default, [4, 8, 2, 512, 128]);  unsqueeze_default = None
        ...
        reshape_default_2: "bf16[4, 16, 512, 128]" = torch.ops.aten.reshape.default(clone_default, [4, 16, 512, 128]);  clone_default = None
