...
class Repro(torch.nn.Module):
    def forward(self, arg15_1: "bf16[7168, 18432]"):
        ...
        permute_default: "bf16[18432, 7168]" = torch.ops.aten.permute.default(arg15_1, [1, 0]);  arg15_1 = None
...
def make_inputs():
    return [
    torch.randn([7168, 18432], dtype=torch.bfloat16, device='cuda'),
    ]
