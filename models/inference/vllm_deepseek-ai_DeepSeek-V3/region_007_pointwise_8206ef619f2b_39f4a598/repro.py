...
class Repro(torch.nn.Module):
    def forward(self, arg14_1: "bf16[18432, 7168]"):
        ...
        permute_default: "bf16[7168, 18432]" = torch.ops.aten.permute.default(arg14_1, [1, 0]);  arg14_1 = None
...
def make_inputs():
    return [
    torch.randn([18432, 7168], dtype=torch.bfloat16, device='cuda'),
    ]
