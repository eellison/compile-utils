...
class Repro(torch.nn.Module):
    def forward(self, arg11_1: "bf16[7168, 16384]"):
        ...
        permute_default: "bf16[16384, 7168]" = torch.ops.aten.permute.default(arg11_1, [1, 0]);  arg11_1 = None
...
def make_inputs():
    return [
    torch.randn([7168, 16384], dtype=torch.bfloat16, device='cuda'),
    ]
