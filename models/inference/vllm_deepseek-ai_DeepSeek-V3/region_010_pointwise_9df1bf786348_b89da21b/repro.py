...
class Repro(torch.nn.Module):
    def forward(self, getitem_6: "bf16[4, 128, 512, 128]"):
        ...
        permute_default: "bf16[4, 512, 128, 128]" = torch.ops.aten.permute.default(getitem_6, [0, 2, 1, 3]);  getitem_6 = None
        clone_default: "bf16[4, 512, 128, 128]" = torch.ops.aten.clone.default(permute_default, memory_format = torch.contiguous_format);  permute_default = None

        # File: /home/dev/.conda/envs/pytorch-work-b200/lib/python3.12/site-packages/transformers/models/deepseek_v3/modeling_deepseek_v3.py:444 in forward, code: attn_output = attn_output.reshape(batch_size, seq_length, -1).contiguous()
        reshape_default: "bf16[4, 512, 16384]" = torch.ops.aten.reshape.default(clone_default, [4, 512, -1]);  clone_default = None
        ...
        reshape_default_1: "bf16[2048, 16384]" = torch.ops.aten.reshape.default(reshape_default, [2048, 16384]);  reshape_default = None
