...
class Repro(torch.nn.Module):
    def forward(self, arg7_1: "bf16[32768, 512]"):
        ...
        permute_default: "bf16[512, 32768]" = torch.ops.aten.permute.default(arg7_1, [1, 0]);  arg7_1 = None
...
def make_inputs():
    return [
    torch.randn([32768, 512], dtype=torch.bfloat16, device='cuda'),
    ]
