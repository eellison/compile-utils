...
class Repro(torch.nn.Module):
    def forward(self, arg5_1: "bf16[576, 7168]"):
        ...
        permute_default: "bf16[7168, 576]" = torch.ops.aten.permute.default(arg5_1, [1, 0]);  arg5_1 = None
...
def make_inputs():
    return [
    torch.randn([576, 7168], dtype=torch.bfloat16, device='cuda'),
    ]
