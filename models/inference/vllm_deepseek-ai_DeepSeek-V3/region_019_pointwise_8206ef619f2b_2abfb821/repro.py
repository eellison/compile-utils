...
class Repro(torch.nn.Module):
    def forward(self, arg4_1: "bf16[24576, 1536]"):
        ...
        permute_default: "bf16[1536, 24576]" = torch.ops.aten.permute.default(arg4_1, [1, 0]);  arg4_1 = None
...
def make_inputs():
    return [
    torch.randn([24576, 1536], dtype=torch.bfloat16, device='cuda'),
    ]
