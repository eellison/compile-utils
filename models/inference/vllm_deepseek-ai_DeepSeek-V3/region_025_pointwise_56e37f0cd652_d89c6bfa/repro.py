...
class Repro(torch.nn.Module):
    def forward(self, arg0_1: "bf16[4, 512, 7168]"):
        # File: /home/dev/.conda/envs/pytorch-work-b200/lib/python3.12/site-packages/transformers/models/deepseek_v3/modeling_deepseek_v3.py:205 in forward, code: hidden_states = hidden_states.view(-1, hidden_states.shape[-1])
