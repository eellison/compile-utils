...
class Repro(torch.nn.Module):
    def forward(self, arg3_1: "bf16[7168, 2048]"):
        ...
        permute_default: "bf16[2048, 7168]" = torch.ops.aten.permute.default(arg3_1, [1, 0]);  arg3_1 = None
...
def make_inputs():
    return [
    torch.randn([7168, 2048], dtype=torch.bfloat16, device='cuda'),
    ]
