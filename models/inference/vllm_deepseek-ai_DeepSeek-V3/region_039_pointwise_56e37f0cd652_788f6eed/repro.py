...
class Repro(torch.nn.Module):
    def forward(self, mm: "bf16[2048, 129280]"):
        ...
        reshape_default: "bf16[4, 512, 129280]" = torch.ops.aten.reshape.default(mm, [4, 512, 129280]);  mm = None
...
def make_inputs():
    return [
    torch.randn([2048, 129280], dtype=torch.bfloat16, device='cuda'),
    ]
