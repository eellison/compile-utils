...
class Repro(torch.nn.Module):
    def forward(self, arg1_1: "bf16[129280, 7168]"):
        # File: /home/dev/.conda/envs/pytorch-work-b200/lib/python3.12/site-packages/transformers/models/deepseek_v3/modeling_deepseek_v3.py:664 in torch_dynamo_resume_in_forward_at_650, code: logits = self.lm_head(hidden_states[:, slice_indices, :])
        permute_default: "bf16[7168, 129280]" = torch.ops.aten.permute.default(arg1_1, [1, 0]);  arg1_1 = None
...
def make_inputs():
    return [
    torch.randn([129280, 7168], dtype=torch.bfloat16, device='cuda'),
    ]
