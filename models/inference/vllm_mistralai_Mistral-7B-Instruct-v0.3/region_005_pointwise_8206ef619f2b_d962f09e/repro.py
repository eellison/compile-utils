...
class Repro(torch.nn.Module):
    def forward(self, arg73_1: "bf16[14336, 4096]"):
        ...
        permute_default: "bf16[4096, 14336]" = torch.ops.aten.permute.default(arg73_1, [1, 0]);  arg73_1 = None
...
def make_inputs():
    return [
    torch.randn([14336, 4096], dtype=torch.bfloat16, device='cuda'),
    ]
