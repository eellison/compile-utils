...
class Repro(torch.nn.Module):
    def forward(self, getitem_63: "bf16[4, 32, 512, 128]"):
        ...
        permute_default: "bf16[4, 512, 32, 128]" = torch.ops.aten.permute.default(getitem_63, [0, 2, 1, 3]);  getitem_63 = None

        # File: /home/dev/.conda/envs/pytorch-work-b200/lib/python3.12/site-packages/transformers/models/mistral/modeling_mistral.py:181 in forward, code: attn_output = attn_output.reshape(*input_shape, -1).contiguous()
        reshape_default: "bf16[4, 512, 4096]" = torch.ops.aten.reshape.default(permute_default, [4, 512, -1]);  permute_default = None
        ...
        reshape_default_1: "bf16[2048, 4096]" = torch.ops.aten.reshape.default(reshape_default, [2048, 4096]);  reshape_default = None
...
def make_inputs():
    return [
    torch.randn([4, 32, 512, 128], dtype=torch.bfloat16, device='cuda'),
    ]
