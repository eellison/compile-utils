...
class Repro(torch.nn.Module):
    def forward(self, mm_51: "bf16[2048, 1024]"):
        ...
        reshape_default: "bf16[4, 512, 1024]" = torch.ops.aten.reshape.default(mm_51, [4, 512, 1024]);  mm_51 = None
        ...
        expand_default: "bf16[4, 8, 4, 512, 128]" = torch.ops.aten.expand.default(unsqueeze_default, [4, 8, 4, 512, 128]);  unsqueeze_default = None
        ...
        reshape_default_2: "bf16[4, 32, 512, 128]" = torch.ops.aten.reshape.default(clone_default, [4, 32, 512, 128]);  clone_default = None
