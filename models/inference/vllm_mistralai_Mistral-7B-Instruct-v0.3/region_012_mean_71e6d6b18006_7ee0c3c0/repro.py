...
class Repro(torch.nn.Module):
    def forward(self, mm_48: "bf16[2048, 4096]", add_46: "bf16[4, 512, 4096]", arg66_1: "bf16[4096]"):
        ...
        reshape_default: "bf16[4, 512, 4096]" = torch.ops.aten.reshape.default(mm_48, [4, 512, 4096]);  mm_48 = None
        ...
        add_tensor: "bf16[4, 512, 4096]" = torch.ops.aten.add.Tensor(add_46, reshape_default);  add_46 = reshape_default = None
        ...
        mul_tensor_1: "bf16[4, 512, 4096]" = torch.ops.aten.mul.Tensor(arg66_1, convert_element_type_default_1);  arg66_1 = convert_element_type_default_1 = None
        ...
        reshape_default_2: "bf16[2048, 4096]" = torch.ops.aten.reshape.default(mul_tensor_1, [2048, 4096])
        ...
        reshape_default_3: "bf16[2048, 4096]" = torch.ops.aten.reshape.default(mul_tensor_1, [2048, 4096]);  mul_tensor_1 = None
