...
class Repro(torch.nn.Module):
    def forward(self, mm: "f32[2048, 201088]"):
        ...
        reshape_default: "f32[4, 512, 201088]" = torch.ops.aten.reshape.default(mm, [4, 512, 201088]);  mm = None
...
def make_inputs():
    return [
    torch.randn([2048, 201088], dtype=torch.float32, device='cuda'),
    ]
