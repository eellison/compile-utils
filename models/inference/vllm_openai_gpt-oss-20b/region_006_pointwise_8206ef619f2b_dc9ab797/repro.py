...
class Repro(torch.nn.Module):
    def forward(self, arg65_1: "f32[32, 2880]"):
        # File: /home/dev/.conda/envs/pytorch-work-b200/lib/python3.12/site-packages/transformers/models/gpt_oss/modeling_gpt_oss.py:154 in forward, code: router_logits = F.linear(hidden_states, self.weight, self.bias)  # (seq_len, num_experts)
        permute_default: "f32[2880, 32]" = torch.ops.aten.permute.default(arg65_1, [1, 0]);  arg65_1 = None
