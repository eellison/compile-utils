...
class Repro(torch.nn.Module):
    def forward(self, arg62_1: "f32[2880, 4096]"):
        ...
        permute_default: "f32[4096, 2880]" = torch.ops.aten.permute.default(arg62_1, [1, 0]);  arg62_1 = None
...
def make_inputs():
    return [
    torch.randn([2880, 4096], dtype=torch.float32, device='cuda'),
    ]
