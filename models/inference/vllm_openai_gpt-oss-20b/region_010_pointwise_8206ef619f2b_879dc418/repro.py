...
class Repro(torch.nn.Module):
    def forward(self, arg59_1: "f32[512, 2880]"):
        ...
        permute_default: "f32[2880, 512]" = torch.ops.aten.permute.default(arg59_1, [1, 0]);  arg59_1 = None
...
def make_inputs():
    return [
    torch.randn([512, 2880], dtype=torch.float32, device='cuda'),
    ]
