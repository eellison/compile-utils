...
class Repro(torch.nn.Module):
    def forward(self, arg55_1: "f32[4096, 2880]"):
        ...
        permute_default: "f32[2880, 4096]" = torch.ops.aten.permute.default(arg55_1, [1, 0]);  arg55_1 = None
...
def make_inputs():
    return [
    torch.randn([4096, 2880], dtype=torch.float32, device='cuda'),
    ]
