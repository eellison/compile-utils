...
class Repro(torch.nn.Module):
    def forward(self, addmm_69: "f32[4096, 4096]"):
        ...
        reshape_default: "f32[8, 512, 4096]" = torch.ops.aten.reshape.default(addmm_69, [8, 512, 4096]);  addmm_69 = None
        ...
        expand_default: "f32[8, 64, 512, 64]" = torch.ops.aten.expand.default(permute_default, [8, 64, 512, 64]);  permute_default = None
