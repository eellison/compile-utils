...
class Repro(torch.nn.Module):
    def forward(self, mm_140: "f32[4096, 4096]"):
        ...
        reshape_default: "f32[8, 512, 4096]" = torch.ops.aten.reshape.default(mm_140, [8, 512, 4096]);  mm_140 = None
        ...
        reshape_default_1: "f32[8, 512, 64, 64]" = torch.ops.aten.reshape.default(reshape_default, [8, 512, 64, 64]);  reshape_default = None
        ...
        clone_default: "f32[8, 64, 512, 64]" = torch.ops.aten.clone.default(permute_default, memory_format = torch.contiguous_format);  permute_default = None
