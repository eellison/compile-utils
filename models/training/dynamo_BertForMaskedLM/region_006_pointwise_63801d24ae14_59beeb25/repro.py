...
class Repro(torch.nn.Module):
    def forward(self, addmm_70: "f32[16384, 3072]"):
        ...
        reshape_default: "f32[32, 512, 3072]" = torch.ops.aten.reshape.default(addmm_70, [32, 512, 3072]);  addmm_70 = None
        ...
        reshape_default_1: "f32[16384, 3072]" = torch.ops.aten.reshape.default(mul_tensor_2, [16384, 3072]);  mul_tensor_2 = None
