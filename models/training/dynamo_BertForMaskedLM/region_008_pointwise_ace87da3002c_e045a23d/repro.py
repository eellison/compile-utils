...
class Repro(torch.nn.Module):
    def forward(self, addmm_68: "f32[16384, 768]"):
        ...
        reshape_default: "f32[32, 512, 768]" = torch.ops.aten.reshape.default(addmm_68, [32, 512, 768]);  addmm_68 = None
        ...
        expand_default: "f32[32, 12, 512, 64]" = torch.ops.aten.expand.default(permute_default, [32, 12, 512, 64]);  permute_default = None
